  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        ...
        console.error('Error fetching bridal content', error);
      }
    };
    fetchContent();
  }, []);
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-8 py-12">
      ...
      <div className="relative h-[250px] md:h-[400px] mb-16 overflow-hidden rounded-sm flex items-center justify-center">
        <img
          src={content['bridal-hero-bg'] || "https://images.pexels.com/photos/32212940/pexels-photo-32212940.jpeg"}
          alt="Bridal Collection"
          className="absolute inset-0 w-full h-full object-center object-cover brightness-[0.7]"
        />
        <div className="relative text-center text-white z-10 px-4">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-display font-medium tracking-[0.3em] mb-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">BRIDAL</h1>
          <p className="text-[10px] md:text-[12px] font-semibold uppercase tracking-[0.4em] opacity-80 max-w-lg mx-auto leading-loose">
            Exquisite masterpieces for your most memorable day. Timeless elegance redefined.
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-between items-end mb-12 border-b border-black/5 pb-8">
        <div>
          <h2 className="text-3xl font-display font-medium tracking-widest mb-2 text-luxury-black">The Bridal Edit</h2>
      ...
      <div className="mb-16 bg-luxury-bg/50 p-6 rounded-sm border border-black/5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative group overflow-hidden rounded-sm aspect-[4/4]">
            <img
              src={content['bridal-signature-img'] || "/assets/images/bridal-look.png"}
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-luxury-gold">Stylist's Selection</span>
              <h3 className="text-3xl md:text-5xl font-display font-medium tracking-widest text-luxury-black leading-tight uppercase">THE SIGNATURE <br />BRIDAL LOOK</h3>
              <p className="text-[13px] text-luxury-text/70 leading-relaxed max-w-md font-sans">
                A masterpiece of heritage and craft. This look pairs our Royal Maroon Lehenga with traditional Kundan jewelry and a sheer gold-bordered dupatta for a timeless, regal presence.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-8 pt-8 border-t border-black/5">
              <div>
                <h4 className="text-[10px] font-bold uppercase tracking-widest mb-3 text-luxury-black">Detail Focus</h4>
                <ul className="text-[11px] text-luxury-muted space-y-2 uppercase tracking-wider">
                  <li>• Zardosi Embroidery</li>
                  <li>• Raw Silk Fabric</li>
                  <li>• Velvet Borders</li>
                </ul>
              </div>
              <div>
                <h4 className="text-[10px] font-bold uppercase tracking-widest mb-3 text-luxury-black">Styling Tip</h4>
                <p className="text-[11px] text-luxury-muted leading-relaxed uppercase tracking-wider">
                  Pair with a double dupatta for a truly royal silhouette.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1">
          {loading ? (
            ...
            <div className="text-center py-40 border border-dashed border-black/10">
              <p className="text-xl font-light uppercase tracking-widest text-gray-400">No bridal pieces match your criteria.</p>
            </div>
          ) : (
